...
- Use `v`-prefixed SemVer release headings with ISO dates in `CHANGELOG.md`, for example `## [v0.5.0] - 2026-09-04`. Keep `mix.exs` versions unprefixed, for example `0.5.0`, and title GitHub Releases with the tag alone, for example `v0.5.0`.
