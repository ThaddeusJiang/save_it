---
title: "The MP4 Metadata Bug Hiding Behind a Telegram Bot Upload"
date: 2026-06-13
kind: post
summary: Why a bot-uploaded video can show the wrong aspect ratio when the same file uploads fine from a Telegram client — and what save_it now passes to sendVideo instead of letting Telegram guess.
---
